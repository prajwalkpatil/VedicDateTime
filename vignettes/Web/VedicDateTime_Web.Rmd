...
The whole concept of <em>VedicDateTime</em> is based on the Hindu calendar system. The lunisolar Hindu calendar and its aspects are as old as <em>Surya Siddhanta</em>, an ancient Sanskrit text on astronomy <sup><a href = "#1">[1]</a></sup> . Even today, this calendar is prevalent in India and it is mostly found in <em>Hindu Panchanga</em> an Indian almanac that details information about the various festivals, rituals, and planetary combinations and has been in use since time immemorial in the Indian subcontinent. This Panchanga can be commonly found in most Indian homes <sup><a href = "#3">[3]</a></sup>.

The <em>VedicDateTime</em> package aims to convert the commonly used Gregorian date-time to the Vedic date-time as per the calculations of the <em>Panchang</em>. Panchanga which means 'five arms' consists of the five most important parts - <em>Tithi, Vaara, Nakshatra, Yoga,</em> and <em>Karana</em>. The <em>Vaara</em> or the day of the week is based on Sun alone; <em>Tithi</em> and <em>Karana</em> are based upon Moon alone; <em>Nakshatra</em> and <em>Yoga</em> are based upon both Moon and Sun. This makes the Hindu calendar a true lunisolar calendar. <em>VedicDateTime</em> contributes a new calendar system in R that can have huge potential to discover meaningful patterns in natural time series.
...
<em>"The luminosity of the Moon is caused by light from the Sun. It is the varying relative positions of the Sun and the Moon that produce the phases of the Moon."</em> <sup><a href = "#3">[3]</a></sup>
...
Tithi doesn't require <em>Ayanamsa</em> because it is the difference of longitudes and even if <em>Ayanamsa</em> is subtracted from each longitude, it doesn't matter <sup><a href = "#2">[2]</a></sup>.
...
<em>"The seven days of the week have the seven Grahas from the Sun to Saturn as their lords."</em>  <sup><a href = "#3">[3]</a></sup>
...
These Karanas recur in regular order starting from the second half of the first day of <em>Shukla-paksha</em> until the first half of the 14th day of the <em>Krishna-paksha</em>. <sup><a href = "#3">[3]</a></sup>
...
<em>"The twelve houses of a horoscope deal with all conceivable aspects of life. The most important of all houses is the lagna or the first house. The remaining houses are basically related to the first house only. The planets in the horoscopic chart are subservient to the lagna, and their original nature undergoes modifications depending upon the lagna."</em>  <sup><a href = "#3">[3]</a></sup>
...
<a id = "2">[2]</a> Ramakumar, K. L. (2011). <strong>Panchangam calculations</strong>. https://archive.org/details/PanchangamCalculations}

<a id = "3">[3]</a> Charak, K. S. (2012). <strong>Elements of Vedic Astrology</strong> (2 Volume Set) (Third Edition). UMA Publications.

<a id = "4">[4]</a> <strong>drik-panchanga</strong> by <strong>Satish BD</strong> on GitHub - https://github.com/webresh/drik-panchanga
